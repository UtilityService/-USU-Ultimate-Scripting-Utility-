...
ui.Name = "UltimateScriptingUtility"
...
function lib:Window(text, preset, closebind)
	...
	function tabhold:Tab(text)
		...
		function tabcontent:Slider(text, min, max, start, callback)
			...
			local currentSlider_Value = start
		...
		function tabcontent:Dropdown(text, default, list, callback)
			...
			DropdownTitle.Text = text .. " - " .. tostring(default)
		...
		function tabcontent:Colorpicker(text, preset, callback)
			...
			function ColorPickerFunctions:Set(color3)
				BoxColor.BackgroundColor3 = color3
				Color.BackgroundColor3 = color3
			end
